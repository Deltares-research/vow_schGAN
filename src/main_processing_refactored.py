...
def main():
    ...
    # =============================================================================
    logger.info("=" * 60)
    logger.info("Step 6: Enhancing generated schemas...")
    ...
    if config.ENHANCE_METHOD and config.ENHANCE_METHOD.lower() != "none":
        ...
        logger.info("Enhancement disabled. Skipping.")

    # =============================================================================
    # 7. CREATE MOSAICS FROM GENERATED SCHEMAS
    # =============================================================================
    logger.info("=" * 60)
    logger.info("Step 7: Creating mosaics...")
    ...
    if config.COMPUTE_UNCERTAINTY:
        ...
        try:
            ...
            uncertainty_files = list(folders["7_uncertainty"].glob("*_uncertainty.csv"))
